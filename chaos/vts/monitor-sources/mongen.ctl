...
@DEFINE R: DSK:
@define unv: dsk:,unv:
@COMPILE /NOBIN mon:SITE.MAC+mon:MONSYM.MAC
@COMPILE mon:SITE.MAC+mon:REL1.MAC+mon:MONSYM.MAC
@EXECUTE mon:SITE.MAC+mon:ERBLD.MAC+mon:REL1.MAC+mon:MONSYM.MAC ERBLD.REL
@DELETE ERBLD.REL
