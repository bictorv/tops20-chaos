! Compile the MM mailsystem with Chaosnet prioritized.
! Leave resulting binaries in the connected directory.
!
! Use binaries which already exist
@define unv: dsk:,<mm.binaries>,unv:
! Use existing binaries, and unchanged sources
@define dsk: dsk:,<mm.binaries>,<mm>
@
! Compile the library that was updated
@compile hstnam
! (Note: BLANKT should be converted to use VTSOP when that has been ported.)
!
!
!
